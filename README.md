...
**This is the easiest way to get started with Simplicity!** No installation required, works in your browser.
...
**Limitations:**
- Simple transactions only (1 input → 1 output + fee)
- No confidential transactions
- Testnet only in public instance
